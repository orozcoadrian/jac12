...
class MyTestCase(unittest.TestCase):
    ...
    def test_Xl_add_data_set_sheet(self):
        ...
        ds = XlBuilder('a_name').add_sheet([{'case_number': '05-2008-CA-033772-XXXX-XX',
                                             ...
                                             'count': 2,
                                             'legal': {'u': None, 'pg': '20', 's': '09', 'pb': '53', 'blk': 'A',
                                                       'lt': '3',
                                                       'r': '36', 'subd': ' WYNDHAM AT DURAN',
